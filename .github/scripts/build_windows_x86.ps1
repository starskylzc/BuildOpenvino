...
$B_DIR = Join-Path $ROOT "build-win-x86"
$OUT_DIR = Join-Path $ROOT "out-win-x86"
...
Write-Host "==> Build OpenCV static (Windows x86)"
...
Write-Host "==> Build OpenCvSharpExtern (Windows x86)"
